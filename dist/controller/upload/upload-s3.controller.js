...
const uploadSingleFile = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, error.message || "Something went wrong during upload", [], true));
    }
});
...
const deleteFile = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, error.message || "Something went wrong during deletion", [], true));
    }
});
